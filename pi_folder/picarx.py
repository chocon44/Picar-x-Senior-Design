...
class Picarx(object):
    ...
    def __init__(self, 
        ...
        self.ultra_servo = Servo(servo_pins[3]) # ADD ULTRA SENSOR TO MAKE IT 
        ...
        self.ultra_servo_vali_val = float(self.config_flie.get("picarx_ultra_servo", default_value=0))  # FOR ULTRA SERVO
        ...
        self.ultra_servo.angle(self.ultra_servo_cali_val)   # FOR ULTRA SERVO
    ...
    # FOR ULTRA SENSOR
    def set_ultra_sensor_angle(self,value):
        self.dir_current_angle = constrain(value, self.DIR_MIN, self.DIR_MAX)
        angle_value  = self.dir_current_angle + self.dir_cali_val
        self.ultra_servo.angle(angle_value)
    ...
    ### FOR PIVOT RIGHT TURN ###
    def PivotRight(self, speed):
        motors = Motors()   # create motors oject from class Motors
        LEFT = 1    # identify each motor
        RIGHT = 2 
